  ...
  return (
    <div className="bg-gray-50">
      ...
      <section className="py-20 px-6 z-1">
        ...
        <div className="grid gap-6 mt-10 max-w-6xl mx-auto px-4 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4">
          {ultimosEventos.map((evento) => (
            <div key={evento.id} className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              <img
                src={evento.image}
                alt="imagem_evento"
